...
| `CLAUDE-certd.md` | certd | PKI: ACME/EST extraction (done) + ARI (Add 1, done) + tls-alpn-01/RFC 8738 IP identifiers (Add 2/3, done 2026-07-06, `make check-acme-challenges`) + RFC 8659 CAA pre-flight (done 2026-07-06, `make check-caa`; TLSA integration was already done elsewhere — dnsd, mistracked here) + RFC 8739 STAR recurrent orders (done 2026-07-06, `make check-star`) — **entire checklist closed** |
